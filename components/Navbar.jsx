...
//       <div className={`max-w-7xl mx-auto bg-[#ff9602] ${isMenuOpen ? 'rounded-none' : 'rounded-full'} ${isMenuOpen ? 'mt-0' : 'mt-2 lg:mt-3'} px-0 lg:px-0 relative`}>
//         <div className="flex justify-between items-center h-16 lg:h-18">
//           {/* Logo - Positioned outside on left */}
//           {!isMenuOpen && (
//             <Link href="/" className="flex items-center space-x-3 z-50 absolute lg:-left-4 top-1/2 transform -translate-y-1/2">
...
//           {/* Desktop Navigation */}
//           <nav className="hidden lg:flex items-center space-x-1 px-6 py-2 ml-24">
//             {navItems.map((item) => (
//               <Link
//                 key={item.name}
//                 href={item.path}
