...
//   return (
//     <div className="relative h-[calc(100vh-5rem)] md:h-[calc(100vh-5rem)] pt-20 w-full overflow-hidden">
//       {/* Main Carousel */}
//       <div className="relative flex items-center justify-center h-full transition-all duration-700 ease-in-out">
...
//             opacity = "opacity-100";
//           } else if (position === 1) {
//             translateX = "md:translate-x-[34rem] translate-x-[4rem]";
...
//             >
//               <div className="relative w-[18rem] h-[28rem] sm:w-[22rem] sm:h-[32rem] md:w-[75rem] md:h-[42rem] rounded-2xl overflow-hidden shadow-lg">
//                 <Image
//                   src={slide.image}
//                   alt={`Slide ${slide.id}`}
//                   layout="fill"
...
//                 {/* Content */}
//                 <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white p-4 md:p-8 bg-gradient-to-t from-black/50 via-black/20 to-transparent">
//                   <div className="space-y-2 sm:space-y-4 md:space-y-6">
//                     <h1 className="text-2xl sm:text-4xl md:text-6xl font-bold text-brand-gold animate-fade-in">
//                       {slide.title}
//                     </h1>
//                     <h2 className="text-xl sm:text-2xl md:text-4xl font-semibold animate-fade-in">
//                       {slide.subtitle}
//                     </h2>
//                     <p className="text-sm sm:text-base md:text-xl max-w-xs sm:max-w-md md:max-w-2xl mx-auto leading-relaxed animate-fade-in">
//                       {slide.description}
//                     </p>
//                     <Button 
//                       size="sm"
//                       className="bg-[#fab604] text-[#1c0f0d] hover:bg-[#fab604] font-bold px-4 py-2 sm:px-6 sm:py-3 md:px-8 md:py-3 text-sm sm:text-base md:text-lg transition-all duration-300 hover:scale-105"
//                     >
//                       {slide.buttonText}
//                     </Button>
//                   </div>
...
//         variant="ghost"
//         size="sm"
//         className="absolute bg-[#fab604] left-2 sm:left-4 top-1/2 -translate-y-1/2 p-1 sm:p-2 md:p-3 rounded-full z-20"
//         onClick={prevSlide}
//       >
//         <ChevronLeft className="w-4 h-4 sm:w-5 sm:h-5 md:w-7 md:h-7 text-[#1c0f0d]" />
//       </Button>

//       <Button
//         variant="ghost"
//         size="sm"
//         className="absolute bg-[#fab604] right-2 sm:right-4 top-1/2 -translate-y-1/2 p-1 sm:p-2 md:p-3 rounded-full z-20"
//         onClick={nextSlide}
//       >
//         <ChevronRight className="w-4 h-4 sm:w-5 sm:h-5 md:w-7 md:h-7 text-[#1c0f0d]" />
//       </Button>
